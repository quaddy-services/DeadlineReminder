 ...
 * clients in which the end user must grant access in a web browser and then
 * copy a code into the application.
 * 
 * <p>
 ...
 * 
 * <p>
 * Warning: the client ID and secret are not secured and are plainly visible to
 * users of your application. It is a hard problem to secure client credentials
 * in installed applications.
 * </p>
 * 
 * <p>
 * In this sample code, it attempts to open the browser using
 * {@link Desktop#isDesktopSupported()}. If that fails, on Windows it tries
 * {@code rundll32}. If that fails, it opens the browser specified in
 * {@link #BROWSER}, though note that currently we've only tested this code with
 * Google Chrome (hence this is the default value).
 * </p>
 * 
 * @author Yaniv Inbar
 */
public class OAuth2Native {
	 ...
	 * false} or {@code null} to prompt user to open the URL in their favorite
	 * browser.
	 */
