	...
	public static void main(String[] args) {
		try {
			try {
				...
				Builder tempCalendarBuilder = com.google.api.services.calendar.Calendar.builder(HTTP_TRANSPORT, JSON_FACTORY)
						.setApplicationName("Google-CalendarSample/1.0");
				client = tempCalendarBuilder.setHttpRequestInitializer(credential).build();
